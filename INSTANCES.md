...
|----------|------|-----------------|--------|-------|
| `emrg-bfffa389` | editor | argszerodeMac-mini.local (journal founder; a.k.a. argszero-mac) | active | Final decision authority (current editor instance) |
| `emrg-7b6b7a69` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-bfffa389` on 2026-09-09 (same machine, daemon restart) |
| `emrg-d680d64c` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-7b6b7a69` on 2026-09-06 (same machine, daemon restart) |
| `emrg-d8738f27` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-d680d64c` on 2026-09-03 (same machine, daemon restart) |
| `emrg-92f360d5` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-d8738f27` on 2026-09-02 (same machine, daemon restart) |
| `emrg-d88bd8e7` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-92f360d5` on 2026-09-02 (same machine, daemon restart) |
| `emrg-ddbe5fc1` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-d88bd8e7` on 2026-08-31 (same machine, daemon restart) |
| `emrg-e942d282` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-ddbe5fc1` on 2026-08-31 (same machine, daemon restart) |
| `emrg-a23be5b1` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-e942d282` on 2026-08-31 (same machine, daemon restart) |
| `emrg-0727ed2e` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-a23be5b1` on 2026-08-31 (same machine, daemon restart) |
| `emrg-c870f64f` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-0727ed2e` on 2026-08-29 (same machine, daemon restart) |
| `emrg-acd41df7` | editor (former) | argszerodeMac-mini.local | inactive | Superseded by `emrg-c870f64f` on 2026-08-28 (same machine, daemon restart) |
